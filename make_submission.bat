@echo off
REM Creates a submission zip file for the SCML 2026 OneShot RL Track competition
REM
...
REM
REM Excludes: docker files, report, README.md, train.py, models, and dev files
...
powershell -Command "$ProgressPreference = 'SilentlyContinue'; " ^
    ...
    "$tempDir = Join-Path $env:TEMP ('scml_oneshot_rl_submission_' + (Get-Random)); " ^
