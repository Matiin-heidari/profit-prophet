...
case "$SLURM_ARRAY_TASK_ID" in
  0)
    export RUN_NAME=sweep_bs_00_baseline
    ;;
  1)
    export RUN_NAME=sweep_bs_01_default_only
    export REWARD_SCORE_DELTA_WEIGHT=0.0
    ;;
  2)
    export RUN_NAME=sweep_bs_02_score_delta_05
    export REWARD_SCORE_DELTA_WEIGHT=0.5
    ;;
  3)
    export RUN_NAME=sweep_bs_03_need_0001
    export REWARD_NEED_WEIGHT=0.0001
    ;;
  4)
    export RUN_NAME=sweep_bs_04_need_00025
    export REWARD_NEED_WEIGHT=0.00025
    ;;
  5)
    export RUN_NAME=sweep_bs_05_need_0005
    export REWARD_NEED_WEIGHT=0.0005
    ;;
  6)
    export RUN_NAME=sweep_bs_06_shortfall_0001
    export REWARD_SHORTFALL_WEIGHT=0.0001
    ;;
  7)
    export RUN_NAME=sweep_bs_07_need_0001_shortfall_0001
    export REWARD_NEED_WEIGHT=0.0001
    export REWARD_SHORTFALL_WEIGHT=0.0001
    ;;
  8)
    export RUN_NAME=sweep_bs_08_need_00025_shortfall_0001
    export REWARD_NEED_WEIGHT=0.00025
    export REWARD_SHORTFALL_WEIGHT=0.0001
    ;;
  9)
    export RUN_NAME=sweep_bs_09_productivity_0005
    export REWARD_PRODUCTIVITY_WEIGHT=0.0005
    ;;
  10)
    export RUN_NAME=sweep_bs_10_productivity_001
    export REWARD_PRODUCTIVITY_WEIGHT=0.001
    ;;
  11)
    export RUN_NAME=sweep_bs_11_need_0001_productivity_0005
    export REWARD_NEED_WEIGHT=0.0001
    export REWARD_PRODUCTIVITY_WEIGHT=0.0005
    ;;
  12)
    export RUN_NAME=sweep_bs_12_need_0001_shortfall_0001_productivity_0005
    export REWARD_NEED_WEIGHT=0.0001
    export REWARD_SHORTFALL_WEIGHT=0.0001
    export REWARD_PRODUCTIVITY_WEIGHT=0.0005
    ;;
  13)
    export RUN_NAME=sweep_bs_13_need_00025_shortfall_0001_productivity_0005
    export REWARD_NEED_WEIGHT=0.00025
    export REWARD_SHORTFALL_WEIGHT=0.0001
    export REWARD_PRODUCTIVITY_WEIGHT=0.0005
    ;;
  14)
    export RUN_NAME=sweep_bs_14_overshoot_0001_disposal_0001
    export REWARD_OVERSHOOT_WEIGHT=0.0001
    export REWARD_DISPOSAL_WEIGHT=0.0001
    ;;
  15)
    export RUN_NAME=sweep_bs_15_need_0001_overshoot_0001_disposal_0001
    export REWARD_NEED_WEIGHT=0.0001
    export REWARD_OVERSHOOT_WEIGHT=0.0001
    export REWARD_DISPOSAL_WEIGHT=0.0001
    ;;
